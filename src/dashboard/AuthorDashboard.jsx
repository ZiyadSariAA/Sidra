        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-lg">
              <h3 className="text-lg font-semibold mb-2 font-arabic">قيد المراجعة</h3>
          ...
          {/* مقالاتي */}
          <div className="mt-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 font-arabic">مقالاتي</h2>
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between bg-white p-4 rounded-lg">
                  <div>
                    <h3 className="font-semibold text-gray-900 font-arabic">عنوان المقال الأول</h3>
                    <p className="text-gray-600 text-sm font-arabic">تاريخ الإرسال: 15 ديسمبر 2024</p>
                  </div>
                ...
                <div className="flex items-center justify-between bg-white p-4 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm font-arabic">تاريخ الإرسال: 12 ديسمبر 2024</p>
                  </div>
                ...
                <div className="flex items-center justify-between bg-white p-4 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm font-arabic">تاريخ الإرسال: 10 ديسمبر 2024</p>
                  </div>
                  <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-sm font-arabic">مرفوض</span>
                </div>
              </div>
            </div>
          </div>
